...
function shell_end() {
	...
	wget https://gitee.com/qt1280/Dola/raw/master/radiusplugin_v2.1a_beta1.tar.gz
...
function install_php(){
	...
	rpm -Uvh https://gitee.com/qt1280/Dola/raw/master/epel-release-6-8.1.noarch.rpm >/dev/null 2>&1
	rpm -Uvh https://gitee.com/qt1280/Dola/raw/master/remi-release-6.rpm >/dev/null 2>&1
	yum install --enablerepo=remi --enablerepo=remi-php${dingd_php} -y httpd php php-gd php-mysql php-pear php-pear-DB
	wget https://gitee.com/qt1280/Dola/raw/master/q2223139086dingd.zip >/dev/null 2>&1
...
http=https:/
host=gitee.com/qt1280/Dola/raw/master
shouquan=shouquan
wenjiann=
shellshibie
shell_tart
